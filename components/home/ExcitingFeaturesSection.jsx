  ...
  return (
    (<motion.div
      ...
      <motion.div
        ...
        <div className="w-full bg-secondary h-4 rounded-full dark:bg-neutral-900" />
      </motion.div>
      <motion.div
    ...
    (<motion.div
      ...
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2  items-center space-x-2 bg-primary dark:bg-black w-full h-4"></motion.div>
      ))}
    </motion.div>)
  );
};
...
const items = [
  {
    ...
    icon: <TbBoxAlignRight className="h-4 w-4 text-neutral-500" />,
  },
  {
